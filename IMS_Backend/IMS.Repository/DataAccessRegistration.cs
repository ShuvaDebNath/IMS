...
using IMS.Repository.Repositories;
...
public static class DataAccessRegistration
{
    public static void AddDataAccessLayer(this IServiceCollection service)
    {
        ...
        service.AddTransient<ILcLogRepository, LcLogRepository>();
        ...
        service.AddSingleton<IGoodsDeliveryRepository, GoodsDeliveryRepository>();
    }
}
