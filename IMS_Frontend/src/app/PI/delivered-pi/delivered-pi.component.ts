...
export class DeliveredPiComponent {
  pageIndex = 1;
  searchText = '';
  length = 100;
  pageSize = 10;
  ...
  Search() {
    ...
    param.parameters = {
      FromDate: fromDate,
      ToDate: toDate,
      PINo: this.SearchForm.value.piNo,
  ...
  DeleteData(item: any) {
    swal
      .fire({
        title: 'Wait!',
        html: `<span>Once you delete, you won't be able to revert this!<br> <b>[${item.PI_No}]</b></span>`,
        icon: 'warning',
  ...
  viewDetails(table: any) {
    ...
    let param = new GetDataModel();
    param.procedureName = '[usp_ProformaInvoice_DetailsForList]';
    param.parameters = {
      PINo: table.PI_No,
    };
