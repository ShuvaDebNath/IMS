...
@Component({
  selector: 'app-pending-return-list',
  templateUrl: './pending-return-list.component.html',
  styleUrls: ['./pending-return-list.component.css']
})
export class PendingReturnListComponent {
pageIndex = 1;
  searchText = '';
  length = 100;
  pageSize = 10;
  ...
  ngOnInit(): void {
    ...
    // var permissions = this.gs.CheckUserPermission("Pending RM List");
    ...
    this.title.setTitle('Pending RM List');
