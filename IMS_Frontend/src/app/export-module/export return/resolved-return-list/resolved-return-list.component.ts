...
@Component({
  selector: 'app-resolved-return-list',
  templateUrl: './resolved-return-list.component.html',
  styleUrls: ['./resolved-return-list.component.css']
})
export class ResolvedReturnListComponent {
pageIndex = 1;
  searchText = '';
  length = 100;
  pageSize = 10;
  ...
  Search() {    
    ...
    param.procedureName = '[usp_ExportRM_Resolved_List]';
    param.parameters = {
      FromDate: fromDate,
      ToDate: toDate,
