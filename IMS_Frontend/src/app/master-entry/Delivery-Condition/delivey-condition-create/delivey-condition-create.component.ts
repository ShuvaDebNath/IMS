...
@Component({
  selector: 'app-delivey-condition-create',
  templateUrl: './delivey-condition-create.component.html',
  styleUrls: ['./delivey-condition-create.component.css']
})
export class DeliveyConditionCreateComponent {
Formgroup!: FormGroup;
  isEdit = false;
  ...
  constructor(
    ...
    let has = this.activeLink.snapshot.queryParamMap.has('Delivery_Condition_ID');
    if (has) {
      this.Delivery_Condition_ID = this.activeLink.snapshot.queryParams['Delivery_Condition_ID'];
      this.isEdit = true;
      this.GetDeliveryConditionEditDataById();
    } else {
      this.isEdit = false;
    }
  }
  ...
  ngOnInit() {
    var permissions = this.gs.CheckUserPermission('Delivery Condition Create');
    ...
    this.title.setTitle('Delivery Condition Create');
    this.GenerateForm();
  ...
  GetDeliveryConditionEditDataById() {
    var ProcedureData = {
      procedureName: '[usp_DeliveryCondition_GetDataById]',
      parameters: {
        id: this.Delivery_Condition_ID,
      },
    };
  ...
  saveData() {
    ...
    var tableName = 'tbl_delivery_condition';
  ...
  updateData() {
    ...
    let condition = { Delivery_Condition_ID: this.Delivery_Condition_ID };
    let tableName = 'tbl_delivery_condition';
