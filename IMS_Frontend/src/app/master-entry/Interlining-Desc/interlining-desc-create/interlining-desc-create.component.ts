...
@Component({
  selector: 'app-interlining-desc-create',
  templateUrl: './interlining-desc-create.component.html',
  styleUrls: ['./interlining-desc-create.component.css']
})
export class InterliningDescCreateComponent {
  Formgroup!: FormGroup;
  isEdit = false;
  IntDescId!: string;
  menu: any;
  ...
  constructor(
    ...
    let has = this.activeLink.snapshot.queryParamMap.has('IntDescId');
    if (has) {
      this.IntDescId = this.activeLink.snapshot.queryParams['IntDescId'];
      this.isEdit = true;
      this.GetIntDescEditDataById();
    } else {
      this.isEdit = false;
    }
  }
  ...
  ngOnInit() {
    var permissions = this.gs.CheckUserPermission('Interlining Description Create');
    ...
    this.title.setTitle('Interlining Description Create');
    this.GenerateForm();
  ...
  GetIntDescEditDataById() {
    var ProcedureData = {
      procedureName: '[usp_InterliningDesc_GetDataById]',
      parameters: {
        id: this.IntDescId,
      },
    };
  ...
  saveData() {
    ...
    var tableName = 'tbl_interlining_description';
  ...
  updateData() {
    ...
    let condition = { InterliningsDescriptionId: this.IntDescId };
    let tableName = 'tbl_interlining_description';
