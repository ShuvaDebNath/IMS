...
@Component({
  selector: 'app-shipment-condition-create',
  templateUrl: './shipment-condition-create.component.html',
  styleUrls: ['./shipment-condition-create.component.css']
})
export class ShipmentConditionCreateComponent {
Formgroup!: FormGroup;
  isEdit = false;
  Id!: string;
  menu: any;
  ...
  constructor(
    ...
    if (has) {
      ...
      this.isEdit = true;
      this.GetTermsOfDeliveryEditDataById();
    } else {
      this.isEdit = false;
    }
  }
  ...
  ngOnInit() {
    var permissions = this.gs.CheckUserPermission('Terms of Delivery Create');
    ...
    this.title.setTitle('Terms of Delivery Create');
    this.GenerateForm();
  ...
  GetTermsOfDeliveryEditDataById() {
    var ProcedureData = {
      procedureName: '[usp_TOD_GetDataById]',
      parameters: {
        id: this.Id,
      },
    };
  ...
  saveData() {
    ...
    var tableName = 'tbl_terms_of_delivery';
  ...
  updateData() {
    ...
    let tableName = 'tbl_terms_of_delivery';
