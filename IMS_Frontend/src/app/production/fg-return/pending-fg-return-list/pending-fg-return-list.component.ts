...
@Component({
  selector: 'app-pending-fg-return-list',
  templateUrl: './pending-fg-return-list.component.html',
  styleUrls: ['./pending-fg-return-list.component.css']
})
export class PendingFgReturnListComponent {
  pageIndex = 1;
  searchText = '';
  length = 100;
  pageSize = 10;
  ...
  ngOnInit(): void {
    ...
    var permissions = this.gs.CheckUserPermission("Pending FG Return List");
    ...
    this.title.setTitle('Pending FG Return List');
