...
@Component({
  selector: 'app-resolved-fg-return-list',
  templateUrl: './resolved-fg-return-list.component.html',
  styleUrls: ['./resolved-fg-return-list.component.css']
})
export class ResolvedFgReturnListComponent {
pageIndex = 1;
  searchText = '';
  length = 100;
  pageSize = 10;
  ...
  ngOnInit(): void {
    ...
    var permissions = this.gs.CheckUserPermission("Resolved FG Return List");
    ...
    this.title.setTitle('Resolved FG Return List');
  ...
  Search() {    
    ...
    param.procedureName = '[usp_FinishGood_Resolved_List]';
    param.parameters = {
      FromDate: fromDate,
      ToDate: toDate,
