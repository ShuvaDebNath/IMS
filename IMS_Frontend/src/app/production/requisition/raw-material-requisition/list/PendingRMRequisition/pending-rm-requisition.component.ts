...
@Component({
    ...
    templateUrl: './pending-rm-requisition.component.html',
    styleUrls: ['./pending-rm-requisition.component.css'],
    imports: [TableModule, InputTextModule, SharedListComponent],
})
export class PendingRMRequisitionComponent implements OnInit {
