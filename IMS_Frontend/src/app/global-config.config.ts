...
export class GlobalConfig {
  ...
  public static LOGIN_URL_USERMANAGE = 'http://localhost:7056/login';

    public static BASE_URL = 'http://localhost:7056/api/';
 public static BASE_URL_REPORT = 'http://localhost:7056/';
