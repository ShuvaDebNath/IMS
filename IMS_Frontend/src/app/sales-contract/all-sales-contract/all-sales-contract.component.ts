...
export class AllSalesContractComponent {
  ...
  ngOnInit(): void {
    ...
    this.title.setTitle('All Sales Contract');
    ...
    swal.fire({
      ...
      didOpen: () => {
        ...
        excelBtn?.addEventListener('click', () => {
          swal.close();
          this.reportService.PrintSalescontractReport(item, 'excel', 'F');
        });

        wordBtn?.addEventListener('click', () => {
          swal.close();
          this.reportService.PrintSalescontractReport(item, 'word', 'F');
        });

        pdfBtn?.addEventListener('click', () => {
          swal.close();
          this.reportService.PrintSalescontractReport(item, 'pdf', 'F');
        });
      },
    });
  }
