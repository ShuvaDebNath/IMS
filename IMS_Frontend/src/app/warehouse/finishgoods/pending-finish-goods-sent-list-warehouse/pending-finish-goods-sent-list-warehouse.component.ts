...
@Component({
  standalone: true,
  selector: 'app-pending-finish-goods-sent-list-warehouse',
  templateUrl: './pending-finish-goods-sent-list-warehouse.component.html',
  styleUrls: ['./pending-finish-goods-sent-list-warehouse.component.css'],
  imports: [FormsModule, CommonModule, TableModule, InputTextModule, DialogModule, ButtonModule],
})
export class PendingFinishGoodsSentListWarehouseComponent implements OnInit {
