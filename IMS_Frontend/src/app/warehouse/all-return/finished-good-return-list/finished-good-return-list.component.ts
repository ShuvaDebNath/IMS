...
@Component({
  selector: 'app-finished-good-return-list',
  templateUrl: './finished-good-return-list.component.html',
  styleUrls: ['./finished-good-return-list.component.css']
})
export class FinishedGoodReturnListComponent {
pageIndex = 1;
  searchText = '';
  length = 100;
  pageSize = 10;
  ...
  ngOnInit(): void {
    ...
    var permissions = this.gs.CheckUserPermission("Finished Good Return List");
    ...
    this.title.setTitle('Finished Good Return List');
  ...
  Search() {    
    ...
    param.procedureName = '[usp_FinishGood_Return_List]';
    param.parameters = {
      FromDate: fromDate,
      ToDate: toDate,
